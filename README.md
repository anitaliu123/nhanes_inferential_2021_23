...
- **Question 2**: "Is there **a difference in the mean** sedentary behavior time between those who are married and those who are not married?"  
    - A Welch’s independent-samples t-test was conducted to compare mean sedentary time between married and unmarried adults. Married participants (n = 4106) reported an average of **353.29 minutes/day** of sedentary behavior, while unmarried participants (n = 3603) averaged **371.96 minutes/day**. The difference was statistically significant (t = 3.851, p = 0.000118), suggesting that married individuals spend less time sitting compared to unmarried individuals.
